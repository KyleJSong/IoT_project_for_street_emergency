<template>
  ...
  <div id="banner">
    <div class="inner split">
      ...
      <section>
        <p>골목길에서 발생할 수 있는 응급 상황에 대비하고, 대처하기 위한 서비스입니다.</p>
      </section>
    </div>
    <br><br>
    <div id="btnWrapper">
      <div>
        <router-link :to ="{name : 'main'}"><button class="btn">현재 응급상황 목록</button></router-link>
        <router-link :to ="{name : 'previous'}"><button class="btn">이전 응급상황 목록</button></router-link>
      </div>
    </div>
  </div>
